#!/bin/bash
BATCHES_PATH="/home/rothhr/Data/Spine/PostElemFxs/MICCAI/orbits/Train_PostOnly_orbits128_100batches"
TRAINED_NET_PATH="/home/rothhr/Data/Spine/PostElemFxs/MICCAI/orbits/Train_PostOnly_orbits128_100batches_ConvNet2"
TRAIN_RANGE="1-100"
TEST_RANGE="1-100"
# common
LAYER_DEF="layers/vertebra/layers-imagenet-1gpu.cfg"
LAYER_PARAMS="layers/vertebra/layer-params-imagenet-1gpu.cfg"
