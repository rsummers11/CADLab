...
# Description:
# File containing definitions of a few data augmentation functions.
# File modified from https://github.com/pytorch/vision/blob/main/references/classification/transforms.py
...
class RandomMixUp(torch.nn.Module):
    ...
    def forward(self, batch: Tensor, targets: Tensor) -> Tuple[Tensor, Tensor]:
        """
        Args:
        ...
        for target in targets:
            ...
            targets_return.append(target)

        return batch, targets_return
