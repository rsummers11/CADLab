...
reg_tps<T>::~reg_tps()
{
    if(this->positionX!=NULL) free(this->positionX); this->positionX=NULL;
    if(this->positionY!=NULL) free(this->positionY); this->positionY=NULL;
    if(this->positionZ!=NULL) free(this->positionZ); this->positionZ=NULL;
    if(this->coefficientX!=NULL) free(this->coefficientX); this->coefficientX=NULL;
    if(this->coefficientY!=NULL) free(this->coefficientY); this->coefficientY=NULL;
    if(this->coefficientZ!=NULL) free(this->coefficientZ); this->coefficientZ=NULL;
}
/* *************************************************************** */
/* *************************************************************** */
template <class T>
