...
void MatrixLogarithmAtomic<MatrixType>::computePade(MatrixType &result, const MatrixType &T, int degree)
{
   ...
   {
   case 3:
      computePade3(result, T);
      break;
   case 4:
      computePade4(result, T);
      break;
   case 5:
      computePade5(result, T);
      break;
   case 6:
      computePade6(result, T);
      break;
   case 7:
      computePade7(result, T);
      break;
   case 8:
      computePade8(result, T);
      break;
   case 9:
      computePade9(result, T);
      break;
   case 10:
      computePade10(result, T);
      break;
   case 11:
      computePade11(result, T);
      break;
   default:
