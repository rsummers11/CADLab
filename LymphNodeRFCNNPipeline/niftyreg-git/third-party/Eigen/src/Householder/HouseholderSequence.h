...
public:
   ...
   Index length() const
   {
      return m_length;   /**< \brief Returns the length of the Householder sequence. */
   }
   Index shift() const
   {
      return m_shift;   /**< \brief Returns the shift of the Householder sequence. */
   }
...
protected:
   ...
   bool trans() const
   {
      return m_trans;   /**< \brief Returns the transpose flag. */
   }
