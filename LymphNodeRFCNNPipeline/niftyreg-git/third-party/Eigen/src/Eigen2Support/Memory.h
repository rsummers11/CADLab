...
{
   return internal::aligned_malloc(size);
}
...
{
   return internal::aligned_realloc(ptr, new_size, old_size);
}
inline void* ei_handmade_aligned_malloc(size_t size)
{
   return internal::handmade_aligned_malloc(size);
}
inline void  ei_handmade_aligned_free(void *ptr)
{
   internal::handmade_aligned_free(ptr);
}
