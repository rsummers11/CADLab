...
public:
   ...
   {
      m_min = (m_min.cwise().min)(p);
      m_max = (m_max.cwise().max)(p);
      return *this;
   }
   ...
   {
      m_min = (m_min.cwise().min)(b.m_min);
      m_max = (m_max.cwise().max)(b.m_max);
      return *this;
   }
   ...
   {
      m_min = (m_min.cwise().max)(b.m_min);
      m_max = (m_max.cwise().min)(b.m_max);
      return *this;
   }
