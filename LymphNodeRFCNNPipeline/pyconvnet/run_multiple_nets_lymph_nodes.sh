...
###DATA_SET_BATCHES_PATH='D:\HolgerRoth\data\Spine\BoneLesions\BoneLesions_highRes_win_iso_trans_rot_4scales_BSPLINE_XYbetterCentered_BATCHES\batch2345_AX_balanced_Gray_5batches'
###OUT_MODEL_DIR='D:\HolgerRoth\data\Spine\BoneLesions\BoneLesions_highRes_win_iso_trans_rot_4scales_BSPLINE_XYbetterCentered_RESULTS\batch2345_AX_balanced_Gray_5batches'
###NUMBER_BATCHES=5

# PANCREAS TRAINING
DATA_SET_BATCHES_PATH='D:\HolgerRoth\data\Pancreas\rois\training_128_dice75_4scales_balanced_5batches'
OUT_MODEL_DIR='D:\HolgerRoth\data\Pancreas\rois\training_128_dice75_4scales_balanced_5batches_ConvNet'
NUMBER_BATCHES=5
...
LAYERS_REL_PATH='pancreas-layers'
...
TYPE='fc32'
#./run_net_lymph_nodes_Nbatches.sh 0 1 $DATA_SET_BATCHES_PATH $OUT_MODEL_DIR $LAYERS_REL_PATH $DATA_PROVIDER $TYPE $NUMBER_BATCHES $IMG_SIZE $IMG_CHANNELS&	
./run_net_lymph_nodes_Nbatches_from_extisting.sh 0 1 $DATA_SET_BATCHES_PATH $OUT_MODEL_DIR $LAYERS_REL_PATH $DATA_PROVIDER $TYPE $NUMBER_BATCHES $IMG_SIZE $IMG_CHANNELS&	
